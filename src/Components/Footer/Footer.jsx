...
const Footer = () => {
  ...
  return (
    ...
    <footer className="w-full text-slate-600">
      {/*      <!-- Main footer --> */}
      <div className="border-t  border-slate-200 bg-slate-100 pt-16 pb-12 text-sm">
        <div className="container mx-auto  px-6">
          <div className="grid max-w-6xl mx-auto grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
            <nav
      ...
      {/*      <!-- Sub Footer --> */}
      <div className="border-t border-gray-600 bg-green-100 py-4 text-sm">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-4 items-center gap-6 md:grid-cols-8 lg:grid-cols-12">
            ...
            <p className="font-semibold text-black">  Image Uploader</p>
            </a>
