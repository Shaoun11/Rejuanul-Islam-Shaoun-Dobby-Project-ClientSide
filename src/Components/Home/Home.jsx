...
const Home = () => {
    ...
    const imageData = image.filter(images => images.name.toLowerCase().includes(searchQuery));
    ...
    const handlephotoupload =async (e) => {
        ...
        axios.post('https://server-internshala.vercel.app/images',{name,photo})
        .then(result=>{
    ...
    return (
        <>
        {/* navber  */}
        <div className='sticky -top-2 z-20 bg-opacity-30'>
             <div className="border-b  border-slate-200 bg-green-100">
        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 py-2 px-6 text-sm text-black md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
      ...
      <header className="border-b-1  relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            >
                <div className="py-4 mx-auto   w-5/6 ">
            <div className="relative mt-1">
              ...
              <input
                type="text"
                id="table-search2"
                className="bg-white border border-black text-gray-900 text-sm rounded-lg block md:w-96 w-72 pl-10 p-2.5"
        ...
        <div>
           ...
           <div className='md:flex flex md:flex-row  flex-col  gap-2'>
<div className=" flex items-center justify-center  bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-no-repeat bg-cover relative items-center"
	...
	<div className="sm:max-w-lg w-full  p-10 bg-white rounded-xl z-10">
		<div className="text-center">
			...
			<p className="mt-2 text-sm text-gray-400">Sharing Moments, One Pixel at a Time.</p>
		</div>
        <form onSubmit={handlephotoupload} className="mt-8 space-y-3" action="#" method="POST">
                    <div className="grid grid-cols-1 space-y-2">
                        <label className="text-sm font-bold text-gray-500 tracking-wide">Name</label>
                            <input   name="name" className="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#10B981]" type="" placeholder="type upload image name"/>
                    </div>
                    <div className="grid grid-cols-1 space-y-2">
                        ...
                        <div className="flex items-center justify-center w-full">
                            <label className="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                                <div className="h-full w-full text-center flex flex-col items-center justify-center items-center  ">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#10B981] group-hover:text-[#10B981]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <input type="file" placeholder='Drag and drop here'   name="photo"  className="py-8 -mt-8   focus:outline-none text-[#10B981] focus:ring-0 focus:border-gray-300 rounded text-sm "/>
                            </label>
                        </div>
                    </div>
                    ...
                    <div>
                        <button type="submit" className="my-5 w-full flex justify-center bg-[#10B981] text-gray-100 p-4  rounded-full tracking-wide
...
<img src="https://cdni.iconscout.com/illustration/premium/thumb/sorry-item-not-found-3328225-2809510.png" alt="" />
      <p className='text-3xl w-full h-[50vh] font-semibold flex justify-center items-center -mt-36 ml-3  '>No item found for this Name.</p>
</div>
    </>:
    <div  className='grid grid-cols-1 md:grid-cols-2 pb-28 lg:grid-cols-3 max-w-6xl mx-auto gap-6'>
{
                imageData.map(imagemap=><ImagePage key={imagemap._d} data={imagemap} ></ImagePage>)
            }
</div>
}
